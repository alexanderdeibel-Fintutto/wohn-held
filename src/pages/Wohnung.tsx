        ...
        <AnimatedCard delay={300} accentColor="primary">
          <CardContent className="p-5">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center"><span className="text-muted-foreground">Kaltmiete</span><span className="font-semibold">{wohnungData.rentCold}</span></div>
              <div className="flex justify-between items-center"><span className="text-muted-foreground">Nebenkosten</span><span className="font-semibold">{wohnungData.rentUtilities}</span></div>
              <div className="h-px bg-border" />
              <div className="flex justify-between items-center"><span className="font-semibold">Gesamtmiete</span><span className="text-xl font-bold text-primary">{wohnungData.rentTotal}</span></div>
            </div>
          </CardContent>
        </AnimatedCard>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div><p className="font-semibold">Kaution</p><p className="text-sm text-muted-foreground">{wohnungData.deposit}</p></div>
              </div>
              ...
              {[
                ...
                return (
                  <CardContent key={meter.label} className="p-4 flex items-center gap-3">
                    ...
                    <div className="flex-1"><p className="font-medium text-sm">{meter.label}</p><p className="text-xs text-muted-foreground font-mono">{meter.value}</p></div>
        ...
        <AnimatedCard delay={450} accentColor="primary">
          <CardContent className="p-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1"><p className="font-semibold">{wohnungData.landlord}</p><p className="text-sm text-muted-foreground">{wohnungData.landlordContact}</p></div>
