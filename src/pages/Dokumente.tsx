  ...
  return (
    <MobileLayout>
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 gradient-sky opacity-95" />
        ...
        <div className="relative px-4 pt-12 pb-8">
          ...
          >
            ...
            <p className="text-white/80 mt-1">Alle Ihre wichtigen Unterlagen</p>
          </motion.div>
        </div>
      </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {doc.important && (
                              <span className="px-1.5 py-0.5 rounded bg-primary/10 text-primary text-[10px] font-bold flex-shrink-0">
                                Wichtig
                              </span>
                            )}
                          </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">Speicherplatz</p>
                  <p className="text-xs text-muted-foreground">8,2 MB von 100 MB verwendet</p>
                </div>
              </div>
              <div className="w-20 h-2 rounded-full bg-muted overflow-hidden">
                <div className="h-full w-[8%] bg-mint rounded-full" />
              </div>
            </div>
          </CardContent>
        </AnimatedCard>
